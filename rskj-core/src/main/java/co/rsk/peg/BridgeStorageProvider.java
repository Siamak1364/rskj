...
public class BridgeStorageProvider {
    ...
    public boolean hasBridgeBtcTxSigHash(Sha256Hash sigHash) {
        ...
        byte[] data = repository.getStorageBytes(
            contractAddress,
            getStorageKeyForBridgeBtcTxSigHashesIndex(sigHash)
        );
    ...
    private void saveBridgeBtcTxSigHash() {
        ...
        repository.addStorageBytes(
            contractAddress,
            getStorageKeyForBridgeBtcTxSigHashesIndex(
    ...
    private DataWord getStorageKeyForBridgeBtcTxSigHashesIndex(Sha256Hash sigHash) {
